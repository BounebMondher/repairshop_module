...
class Repairshop extends Module
{
    public function __construct()
    {
        ...
        $this->description = $this->l('Keep track of your repairs status,
         and keep your clients informed in real-time (back office & front office display)');
    ...
    public function install()
    {
        ...
        return parent::install() && $this->registerHook($hookName) &&
            ...
            $this->registerHook('displayBackOfficeFooter') && $this->createTabLink();
    }
    ...
    public function hookDisplayBackOfficeFooter()
    {
        echo '<script type="text/javascript" src="'
            . (__PS_BASE_URI__) . 'modules/' . $this->name . '/views/js/icon.js"></script>';
    }
