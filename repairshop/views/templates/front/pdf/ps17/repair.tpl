...
<div style="font-size: 8pt; color: #444">
    <!-- nom -->
    <div style="text-align:center; font-size:1.2em; padding-bottom:3em; font-weight:bold;">{$repair_name|escape:'htmlall':'UTF-8'}</div>
    <br/>
    ...
    <table id="cart_summary" width="100%" style="text-align:left;" cellpadding="3">
                                        ...
                                        <div>
                                            <ul>
                                                {foreach $custom_data as $picture}
                                                    <li>
                                                        <img src="{$PS_UPLOAD_DIR|escape:'htmlall':'UTF-8'}{$picture.value|escape:'htmlall':'UTF-8'}_small"
                                                             alt=""/></li>
                                                {/foreach}
                                            </ul>
                                        </div>
        ...
        <tr>
            <td colspan="6" style="text-align:right; font-weight:bold;">
                {l s='Shipping cost' mod='repairshop'}
        ...
        {if $use_taxes}
            <tr>
                <td colspan="6"
                    style="text-align:right; font-weight:bold;">{l s='Total (tax excl.)' mod='repairshop'}</td>
                <td colspan="1" id="total_price_without_tax"
                    style="text-align:right;">{displayPrice price=$total_price_without_tax}</td>
            </tr>
            <tr>
