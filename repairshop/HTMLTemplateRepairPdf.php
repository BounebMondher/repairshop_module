...
class HTMLTemplateRepairPdf extends HTMLTemplate
{
    ...
    public function getContent()
    {
        ...
        if (version_compare(_PS_VERSION_, '1.7.0', '>=') === true) {
            ...
            $pdf_shopping_cart_dir = _PS_MODULE_DIR_
                . 'repairshop/views/templates/front/pdf/shopping-cart-product-line.tpl';
        }

        $priceDisplay = ((int)Configuration::get('PS_TAX') == 0)
            ? 1 : Product::getTaxCalculationMethod((int)$this->cart_object->id_customer);
    ...
    protected function getLogo()
    {
        ...
        if (Configuration::get('PS_LOGO_INVOICE', null, null, (int)$this->cart_object->id_shop) != false &&
            file_exists(_PS_IMG_DIR_
                . Configuration::get('PS_LOGO_INVOICE', null, null, (int)$this->cart_object->id_shop))
        ) {
