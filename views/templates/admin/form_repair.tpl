...
<form action="{$href|escape:'htmlall':'UTF-8'}" method="post" enctype="multipart/form-data" id="repairForm">
    ...
    <input type="hidden"
           value="{if isset($obj->id_repair) && $obj->id_repair!=""}{$obj->id_cart|escape:'htmlall':'UTF-8'}{/if}"
           name="idCart" id="repair_id_cart"/>
    <!-- name -->
    <div class="panel">
        ...
        <div class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-lg-7">
                    <input type="text" value="{if isset($obj)}{$obj->name|escape:'htmlall':'UTF-8'}{/if}"
                           name="repair_name"/>
                </div>
            </div>
        </div>
    ...
    <div class="panel">
        ...
        <div class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-lg-7">
                    <input placeholder="iPhone X, Galaxy S9, Mac book Pro, Smart TV, iPad air ..." type="text"
                           value="{if isset($obj)}{$obj->device|escape:'htmlall':'UTF-8'}{/if}" name="repair_device"/>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-7">
                    ...
                    <select id="repair_status" name="repair_status">
                        <option {if isset($obj) && $obj->statut == 1}selected{/if}
                                value="1">{l s='waiting for repair' mod='repairshop'}</option>
                        <option {if isset($obj) && $obj->statut == 2}selected{/if}
                                value="2">{l s='waiting for hardware' mod='repairshop'}</option>
                        <option {if isset($obj) && $obj->statut == 3}selected{/if}
                                value="3">{l s='repair in progress' mod='repairshop'}</option>
                        <option {if isset($obj) && $obj->statut == 4}selected{/if}
                                value="4">{l s='repaired' mod='repairshop'}</option>
                        <option {if isset($obj) && $obj->statut == 5}selected{/if}
                                value="5">{l s='unrepairable' mod='repairshop'}</option>
                        <option {if isset($obj) && $obj->statut == 6}selected{/if}
                                value="6">{l s='returned to client' mod='repairshop'}</option>
                    </select>
            ...
            <div class="form-group redirect_product_options redirect_product_options_product_choise">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="input-group">
                        <input type="text" id="repair_customer_autocomplete_input"
                               name="repair_customer_autocomplete_input" autocomplete="off" class="ac_input"/>
                    ...
                    <h2 style="clear:both;">
                        <i class="icon-male"></i>
                        <span href="" id="repair_customer_info"><span
                                    style="color:red">{l s='Please choose a customer' mod='repairshop'}</span></span>
                    </h2>
                </div>
    ...
    <div class="panel">
        ...
        <div class="form-horizontal">
            ...
            <div class="col-lg-7">
                <input type="hidden" value="" name="id_product_redirected"/>
                <div class="input-group">
                    <input type="text" id="repair_product_autocomplete_input" name="repair_product_autocomplete_input"
    ...
    <div class="panel">
        ...
        <div class="form-horizontal">
            ...
            <div class="col-lg-7">
                <textarea
                        name="message">{if isset($obj->message)}{$obj->message|escape:'htmlall':'UTF-8'}{/if}</textarea>
    ...
    <div class="panel">
        ...
        <div class="form-horizontal">
            ...
            <div class="col-lg-1"><span class="pull-right"></span></div>
            <label class="control-label col-lg-2">
                <a href="#" id="repair_refresh_total_repair" style="display:inline-block; vertical-align:middle;"><i
                            class="process-icon-refresh"></i></a>{l s='Refesh total' mod='repairshop'}
            </label>
            <div style="clear:both;"></div>
        </div>
    </div>
    ...
    <div class="panel">
        <div class="panel-footer">
            <a href="{$hrefCancel|escape:'htmlall':'UTF-8'}" class="btn btn-default"><i
                        class="process-icon-cancel"></i> {l s='cancel' mod='repairshop'}</a>
            <button id="repairBtnSubmit" disable="true" type="submit" name="submitAddrepair"
                    class="btn btn-default pull-right"><i class="process-icon-save"></i> {l s='save' mod='repairshop'}
            </button>
        </div>
    </div>
</form>
