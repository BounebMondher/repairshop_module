...
{/if}
<form action="{$adminModuleUrl|escape:'htmlall':'UTF-8'}" method="post" enctype="multipart/form-data"
    ...
    <div class="panel" id="fieldset_0">
        ...
        <div class="form-wrapper">
            ...
            <div class="form-group">
                <label class="control-label col-lg-3"
                       for="sendMailtoCustomer">{l s='Send mail to customer' mod='opartdevis'} :</label>
                <div class="col-lg-9">
                    <input type="checkbox" id="sendMailtoCustomer" name="sendMailtoCustomer" value="1"
                           {if isset($fieldsValue.sendMailtoCustomer) && $fieldsValue.sendMailtoCustomer==1}checked="checked"{/if}>
                    <p class="help-block">{l s='Send an email to customer with quotation pdf' mod='opartdevis'}</p>
                </div>
                <label class="control-label col-lg-3" for="sendMailtoAdmin">{l s='Send mail to admin' mod='opartdevis'}
                    :</label>
                <div class="col-lg-9">
                    <input type="checkbox" id="sendMailtoAdmin" name="sendMailtoAdmin" value="1"
                           {if isset($fieldsValue.sendMailtoAdmin) && $fieldsValue.sendMailtoAdmin==1}checked="checked"{/if}>
                    <p class="help-block">{l s='Send an email to admin with quotation pdf' mod='opartdevis'}</p>
                </div>
                <label class="control-label col-lg-3" for="adminMail">{l s='Choose admin contact' mod='opartdevis'}
                    :</label>
                <div class="col-lg-9">
                    <select name="adminContactId">
                        {foreach $contacts as $contact}
                            <option value="{$contact.id_contact|escape:'htmlall':'UTF-8'}"
                                    {if isset($fieldsValue.adminContactId) && $fieldsValue.adminContactId==$contact.id_contact}selected="selected"{/if}>{$contact.name|escape:'htmlall':'UTF-8'}
                ...
                <label class="control-label col-lg-3" for="validationText">{l s='Validation text' mod='opartdevis'}
                    :</label>
                <div class="col-lg-9">
				...
				input_value=$validationTextValue} *}
                    <p class="help-block">
                        ...
                        {l s='Ex:' mod='opartdevis'} {l s='To validate your order, you just need to send us back the quote signed to the following address:' mod='opartdevis'} {l s='company name' mod='opartdevis'}
                        - {l s='address' mod='opartdevis'} - {l s='postcode' mod='opartdevis'}
                        - {l s='city' mod='opartdevis'}
                    </p>
                </div>

                <label class="control-label col-lg-3"
                       for="goodforagrementText">{l s='Good for agrement text' mod='opartdevis'} :</label>
                <div class="col-lg-9">
                ...
                <label class="control-label col-lg-3"
                       for="maxProdFirstPage">{l s='Maximum product on first page' mod='opartdevis'} :</label>
                <div class="col-lg-9">
                    <input type="text" id="maxProdFirstPage" name="maxProdFirstPage"
                           value="{if isset($fieldsValue.maxProdFirstPage)}{$fieldsValue.maxProdFirstPage|escape:'htmlall':'UTF-8'}{else}6{/if}"/>
                    <p class="help-block">{l s='Set here the maximum number of product will be displaying on the first pdf page.' mod='opartdevis'}</p>
                </div>

                <label class="control-label col-lg-3"
                       for="maxProdPage">{l s='Maximum product on others pages' mod='opartdevis'} :</label>
                <div class="col-lg-9">
                    <input type="text" id="maxProdPage" name="maxProdPage"
                           value="{if isset($fieldsValue.maxProdPage)}{$fieldsValue.maxProdPage|escape:'htmlall':'UTF-8'}{else}10{/if}"/>
                ...
                <label class="control-label col-lg-3" for="expireTime">{l s='Quotation are valid for' mod='opartdevis'}
                    :</label>
                <div class="col-lg-9">
                    <input type="text" id="maxProdPage" name="expireTime"
                           value="{$fieldsValue.expireTime|escape:'htmlall':'UTF-8'}"/>
                ...
                <label class="control-label col-lg-3" for="showFreeForm">{l s='Display free form' mod='opartdevis'}
                    :</label>
                <div class="col-lg-9">
                    <select name="showFreeForm" id="showFreeForm">
                        <option value="1"
                                {if isset($fieldsValue.showFreeForm) && $fieldsValue.showFreeForm==1}selected="selected"{/if}>{l s='yes' mod='opartdevis'}</option>
                        <option value="0"
                                {if isset($fieldsValue.showFreeForm) && $fieldsValue.showFreeForm==0}selected="selected"{/if}>{l s='no' mod='opartdevis'}</option>
                    </select>
                    <p class="help-block">{l s='Set yes if you wan\'t that your customers be able to fill the free form' mod='opartdevis'}</p>
                </div>

                <label class="control-label col-lg-3"
                       for="showAccountBtn">{l s='The \'My quotation\' button is always displayed' mod='opartdevis'}
                    :</label>
                <div class="col-lg-9">
                    <select name="showAccountBtn" id="showFreeForm">
                        <option value="1"
                                {if isset($fieldsValue.showAccountBtn) && $fieldsValue.showAccountBtn==1}selected="selected"{/if}>{l s='yes' mod='opartdevis'}</option>
                        <option value="0"
                                {if isset($fieldsValue.showAccountBtn) && $fieldsValue.showAccountBtn==0}selected="selected"{/if}>{l s='no' mod='opartdevis'}</option>
                    </select>
        ...
        <div class="panel-footer">
            <button type="submit" value="1" id="module_form_submit_btn" name="submitSettings"
